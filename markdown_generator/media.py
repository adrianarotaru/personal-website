...
#
# Takes a TSV of media with metadata and converts them for use with [academicpages.github.io](academicpages.github.io). This is an interactive Jupyter notebook ([see more info here](httpss://jupyter-notebook-beginner-guide.readthedocs.io/en/latest/what_is_jupyter.html)). The core python code is also in `media.py`. Run either from the `markdown_generator` folder after replacing `media.tsv` with one containing your data.
#
...
#     - The .md file will be `YYYY-MM-DD-[url_slug].md` and the permalink will be `httpss://[yourdomain]/media/YYYY-MM-DD-[url_slug]`
